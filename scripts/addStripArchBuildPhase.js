...
module.exports = function(context) {
  ...
  var hasStripArchBuildPhase = buildPhases.filter(buildPhase => buildPhase.comment == buildPhaseComment).length > 0
...
mv "$FRAMEWORK_EXECUTABLE_PATH-merged" "$FRAMEWORK_EXECUTABLE_PATH"
  ...
  var buildPhase = myProj.addBuildPhase([], 'PBXShellScriptBuildPhase', buildPhaseComment, myProj.getFirstTarget().uuid, options).buildPhase;
